...
// @author       alexvermaning0 
// @match        *://open.spotify.com/*
// @icon         https://raw.githubusercontent.com/alexvermaning0/lyrics-status/main/Logo.png
// @grant        none
...
function updatePlaybackState() {
    ...
    return $.ajax({
        ...
        statusCode: {
            ...
            404: () => { addLog("Got unexpected error! For more details please read <a style=\"color: #ff0000;\" href=\"https://github.com/alexvermaning0/lyrics-status#error-list\" target=\"_blank\">this</a>. <strong class=\"error\">Error code: 404</strong>", "error"); errorCount++ },
            502: () => { addLog("Got unexpected error! For more details please read <a style=\"color: #ff0000;\" href=\"https://github.com/alexvermaning0/lyrics-status#error-list\" target=\"_blank\">this</a>. <strong class=\"error\">Error code: 502</strong>", "error"); errorCount++ }
        }
    });
}
